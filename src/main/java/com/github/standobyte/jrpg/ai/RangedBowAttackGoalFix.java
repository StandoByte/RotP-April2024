...
public class RangedBowAttackGoalFix<T extends MobEntity /* literally no reason for this to be a MonsterEntity */ & IRangedAttackMob> extends Goal {
    private final T mob;
    ...
    public RangedBowAttackGoalFix(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_) {
